...
ttk.Label(
    q1,
    text="How old was Queen Elizabeth II when she was crowned Queen of England?"
).pack(side=TOP)
...
ttk.Label(
    q2,
    text="What is the name of Thomas Jefferson's main house?").pack(side=TOP)
ttk.Label(q2, text="This question is worth 3 points ").pack(side=TOP)

answer2 = StringVar(q2, "monticello")
Radiobutton(q2, text="monticello", variable=answer2,
            value="monticello").pack(side=LEFT)

Radiobutton(q2, text="cedar", variable=answer2, value="cedar").pack(side=LEFT)

Radiobutton(q2, text="vernon", variable=answer2,
            value="vernon").pack(side=LEFT)

Radiobutton(q2, text="greentown", variable=answer2,
            value="greentown").pack(side=LEFT)
...
next2 = ttk.Button(q2, text="next", command=switchframe1)

ttk.Label(
    q3,
    text="What year was the wreck of the Titanic discovered?").pack(side=TOP)

#next2= ttk.Button (win, text="next", command=switchframe1)
...
def answer_count():
  ...
  if answer1.get() == "27":
    points += 5
    ttk.Label(q2,
              text="Your previous answer was Correct! Your score is " +
              str(points)).pack(side=TOP)
  else:
    # print("wrong")
    ttk.Label(q2,
              text="Your previous answer was Incorrect! Your score is " +
              str(points)).pack(side=TOP)
